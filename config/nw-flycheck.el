...
(use-package flycheck
  ...
  (progn
    ...
    (defun nw-flycheck-display-error-messages (errors)
    ...
    (defun nw-flycheck-toggle-error-list ()
  ...
  (progn
    ...
    (setq flycheck-display-errors-function 'nw-flycheck-display-error-messages)
    ...
    (spacemacs-keys-set-leader-keys
      ...
      "el" 'nw-flycheck-toggle-error-list
